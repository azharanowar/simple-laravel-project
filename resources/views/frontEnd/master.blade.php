                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <a href="single-post.html" class="img-bg d-flex align-items-end"
                                   style="background-image: url('{{ asset('frontEndAssets') }}/assets/img/post-slide-1.jpg');">
                            ...
                            <div class="swiper-slide">
                                <a href="single-post.html" class="img-bg d-flex align-items-end"
                                   style="background-image: url('{{ asset('frontEndAssets') }}/assets/img/post-slide-2.jpg');">
                                    <div class="img-bg-inner">
                            ...
                            <div class="swiper-slide">
                                <a href="single-post.html" class="img-bg d-flex align-items-end"
                                   style="background-image: url('{{ asset('frontEndAssets') }}/assets/img/post-slide-3.jpg');">
                                    <div class="img-bg-inner">
                            ...
                            <div class="swiper-slide">
                                <a href="single-post.html" class="img-bg d-flex align-items-end"
                                   style="background-image: url('{{ asset('frontEndAssets') }}/assets/img/post-slide-4.jpg');">
                                    <div class="img-bg-inner">
                ...
                <div class="col-lg-4">
                    <div class="post-entry-1 lg">
                        <a href="single-post.html"><img
                                src="{{ asset('frontEndAssets') }}/assets/img/post-landscape-1.jpg" alt=""
                                class="img-fluid"></a>
                        ...
                        <div class="d-flex align-items-center author">
                            <div class="photo"><img src="{{ asset('frontEndAssets') }}/assets/img/person-1.jpg" alt=""
                                                    class="img-fluid"></div>
                            <div class="name">
                    ...
                    <div class="row g-5">
                        <div class="col-lg-4 border-start custom-border">
                            <div class="post-entry-1">
                                <a href="single-post.html"><img
                                        src="{{ asset('frontEndAssets') }}/assets/img/post-landscape-2.jpg" alt=""
                                        class="img-fluid"></a>
                            ...
                            <div class="post-entry-1">
                                <a href="single-post.html"><img
                                        src="{{ asset('frontEndAssets') }}/assets/img/post-landscape-5.jpg" alt=""
                                        class="img-fluid"></a>
                            ...
                            <div class="post-entry-1">
                                <a href="single-post.html"><img
                                        src="{{ asset('frontEndAssets') }}/assets/img/post-landscape-7.jpg" alt=""
                                        class="img-fluid"></a>
                        ...
                        <div class="col-lg-4 border-start custom-border">
                            <div class="post-entry-1">
                                <a href="single-post.html"><img
                                        src="{{ asset('frontEndAssets') }}/assets/img/post-landscape-3.jpg" alt=""
                                        class="img-fluid"></a>
                            ...
                            <div class="post-entry-1">
                                <a href="single-post.html"><img
                                        src="{{ asset('frontEndAssets') }}/assets/img/post-landscape-6.jpg" alt=""
                                        class="img-fluid"></a>
                            ...
                            <div class="post-entry-1">
                                <a href="single-post.html"><img
                                        src="{{ asset('frontEndAssets') }}/assets/img/post-landscape-8.jpg" alt=""
                                        class="img-fluid"></a>
                ...
                <div class="col-md-9">
                    ...
                    <div class="d-lg-flex post-entry-2">
                        <a href="single-post.html" class="me-4 thumbnail mb-4 mb-lg-0 d-inline-block">
                            <img src="{{ asset('frontEndAssets') }}/assets/img/post-landscape-6.jpg" alt=""
                                 class="img-fluid">
                        </a>
                        <div>
                            <div class="post-meta"><span class="date">Culture</span> <span class="mx-1">&bullet;</span>
                            ...
                            <div class="d-flex align-items-center author">
                                <div class="photo"><img src="{{ asset('frontEndAssets') }}/assets/img/person-2.jpg"
                ...
                <div class="col-md-9 order-md-2">
                    ...
                    <div class="d-lg-flex post-entry-2">
                        <a href="single-post.html" class="me-4 thumbnail d-inline-block mb-4 mb-lg-0">
                            <img src="{{ asset('frontEndAssets') }}/assets/img/post-landscape-3.jpg" alt=""
                                 class="img-fluid">
                        </a>
                        <div>
                            ...
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio placeat
                                ...
                                deserunt aliquam temporibus sapiente, laudantium dolorum itaque libero eos deleniti?</p>
                            <div class="d-flex align-items-center author">
                                <div class="photo"><img src="{{ asset('frontEndAssets') }}/assets/img/person-4.jpg"
                                                        alt="" class="img-fluid"></div>
                                <div class="name">
                                    <h3 class="m-0 p-0">Wade Warren</h3>
                                </div>
            ...
            <div class="row g-5">
                <div class="col-lg-4">
                    <div class="post-entry-1 lg">
                        ...
                        <div class="d-flex align-items-center author">
                            <div class="photo"><img src="{{ asset('frontEndAssets') }}/assets/img/person-7.jpg" alt=""
                                                    class="img-fluid"></div>
                            <div class="name">
                ...
                <div class="col-lg-8">
                    <div class="row g-5">
                        <div class="col-lg-4 border-start custom-border">
                            ...
                            <div class="post-entry-1">
                                <a href="single-post.html"><img
                                        src="{{ asset('frontEndAssets') }}/assets/img/post-landscape-4.jpg" alt=""
                                        class="img-fluid"></a>
                                <div class="post-meta"><span class="date">Lifestyle</span> <span
                                        class="mx-1">&bullet;</span> <span>Mar 15th '22</span></div>
                                <h2><a href="single-post.html">Why Craigslist Tampa Is One of The Most Interesting
